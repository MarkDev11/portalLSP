...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Update slide: {{ $slide->title ?: 'Untitled' }}</p>
        </div>
    ...
    @if($slide->image_path)
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="aspect-video bg-gray-100 rounded-lg overflow-hidden max-w-md">
    ...
    <!-- Form -->
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('admin.carousel-slides.update', $slide->id) }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="page" id="page" value="{{ old('page', $slide->page) }}" required
                ...
                <div>
                    ...
                    <input type="number" name="order_index" id="order_index" value="{{ old('order_index', $slide->order_index) }}" required min="0"
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          ...
                          placeholder="Slide description or subtitle">{{ old('description', $slide->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="button_link" id="button_link" value="{{ old('button_link', $slide->button_link) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="gradient_from" id="gradient_from" value="{{ old('gradient_from', $slide->gradient_from) }}"
                ...
                <div>
                    ...
                    <input type="text" name="gradient_to" id="gradient_to" value="{{ old('gradient_to', $slide->gradient_to) }}"
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-center text-sm text-blue-800">
            ...
            <span>Last updated: {{ $slide->updated_at->format('d M Y, H:i') }}</span>
        </div>
    </div>
</div>
@endsection
